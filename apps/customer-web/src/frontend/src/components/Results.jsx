  ...
  return (
    ...
    >
      ...
      <div className="flex items-start relative z-10">
        <motion.span className="font-heading text-[4rem] lg:text-[5rem] text-theme-dark leading-none font-medium">
          {rounded}
        </motion.span>
        <span className="font-heading text-[2.5rem] lg:text-[3rem] text-theme-accent font-light ml-1">%</span>
      </div>
      <p className="text-[14px] lg:text-[15px] text-theme-dark/70 font-medium mt-4 max-w-[160px] leading-[1.6] uppercase tracking-[0.15em]">
        {label}
      </p>
    </motion.div>
  );
...
const BeforeAfterReveal = () => {
  ...
  return (
    <div className="relative w-full aspect-[4/5] lg:aspect-[4/3] rounded-[48px] lg:rounded-[64px] overflow-hidden shadow-[0_40px_100px_rgba(43,89,104,0.15)] bg-theme-surface group border border-white/40">
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-theme-dark/10 mix-blend-multiply" />
      </div>

      {/* LABELS */}
      <div className="absolute top-6 lg:top-10 left-6 lg:left-10 px-5 py-2 bg-theme-dark/20 backdrop-blur-md rounded-full border border-white/10 pointer-events-none z-10 transition-opacity duration-300">
      ...
      <div className="absolute top-6 lg:top-10 right-6 lg:right-10 px-5 py-2 bg-white/30 backdrop-blur-md rounded-full border border-white/40 pointer-events-none z-10 transition-opacity duration-300">
        <span className="text-[11px] lg:text-[12px] font-bold tracking-[0.2em] text-theme-dark uppercase">After</span>
      </div>
...
export default function Results() {
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative w-full bg-theme-surface py-32 lg:py-48 overflow-hidden font-body text-theme-dark selection:bg-theme-secondary selection:text-theme-dark"
    >
      {/* LUXURY BACKGROUND */}
      ...
      <div className="max-w-[1500px] mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-20 lg:mb-32">
          ...
          <motion.h2 
            ...
            className="font-heading text-[3.2rem] sm:text-[4.5rem] lg:text-[5.5rem] leading-[1.05] tracking-tight text-theme-dark mb-8"
          >
            The Art of <br />
          ...
          <motion.p
            ...
            className="text-[17px] text-theme-dark/70 font-medium leading-[2] max-w-[600px]"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-6 bg-white/20 backdrop-blur-md border border-white/50 p-8 lg:p-10 rounded-[32px] shadow-[0_20px_50px_rgba(43,89,104,0.05)]">
                <h3 className="font-heading text-[22px] font-medium text-theme-dark mb-2">Visible Improvements</h3>
                <div className="flex flex-wrap gap-3">
                  {resultHighlights.map((highlight, idx) => (
                    <div key={idx} className="flex items-center gap-2 px-4 py-2 bg-theme-surface/80 rounded-full border border-theme-dark/5">
                      <Sparkles size={12} className="text-theme-accent" />
                      <span className="text-[13px] font-bold text-theme-dark/80 tracking-wide">{highlight}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="pl-4 lg:pl-8 border-l-2 border-theme-accent/30">
                <h4 className="font-heading text-[20px] font-medium text-theme-dark mb-4">Botanical Infusion</h4>
                <p className="text-[15px] text-theme-dark/60 font-medium leading-[1.9] mb-6">
                  Powered by our signature fruit complex, the formula penetrates deeply to repair and protect the skin barrier.
                </p>
                <div className="flex flex-wrap gap-x-6 gap-y-3">
                  {ingredients.map((ing, idx) => (
                    <span key={idx} className="text-[12px] font-bold uppercase tracking-[0.2em] text-theme-dark/50">
                      {ing}
                    </span>
                  ))}
                </div>
            ...
            <div className="lg:col-span-8 relative z-10 order-1 lg:order-2">
              ...
              >
                <div className="absolute inset-0 bg-theme-dark/10 mix-blend-overlay z-10" />
