...
export default function FeaturedCategories() {
  return (
    <section className="relative w-full bg-[#fcfaf9] py-10 lg:py-16 overflow-hidden font-body text-black selection:bg-theme-secondary selection:text-black">
      ...
      */}
      ...
      <div className="max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        ...
        {/* 
          ...
          =========================================
        */}
        <div className="flex flex-col items-center text-center mb-6 lg:mb-8 mt-0">
          <motion.div
          ...
          <motion.h2
            ...
            className="font-heading text-[3.2rem] sm:text-[4rem] lg:text-[4.5rem] leading-[1.05] tracking-tight text-black mb-3"
          >
