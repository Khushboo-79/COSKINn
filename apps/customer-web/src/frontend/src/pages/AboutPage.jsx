...
import cosmeticsHeroImg from '../assets/images/fairy_carriage_banner.webp';
...
export default function AboutPage() {
  ...
  return (
    <div className="bg-[#FFFDFD] min-h-screen font-sans selection:bg-[#FF2D7A]/20">
      <SEO
        title="About COSKINn | Our Story & Philosophy"
        description="Learn about COSKINn's journey. We blend nature, science, and fairytale magic to create clean, luxurious, and highly effective skincare and cosmetics."
        url="https://www.coskinn.com/about"
      />

      {/* 1. PREMIUM HERO SECTION */}
      {isCosmetics ? (
        <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#FFFDFD]">
          <img src={cosmeticsHeroImg} alt="Cosmetics Magic" className="absolute inset-0 w-full h-full object-cover z-0 blur-[4px] scale-[1.02]" />
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col items-center justify-center text-center pt-20"
          >
            <div className="flex items-center gap-2 text-sm font-bold tracking-widest uppercase text-white/80 mb-6 bg-white/20 px-6 py-2 rounded-full backdrop-blur-md border border-white/50">
              <Link to="/" className="hover:text-white transition-colors">Home</Link>
              <span>/</span>
              <span className="text-white">About Us</span>
            </div>

            <h1 className="text-6xl md:text-7xl lg:text-8xl font-black text-white leading-[1.05] tracking-tighter mb-8 drop-shadow-xl" style={{ fontFamily: 'var(--font-heading)' }}>
              Magic Meets <br />
              <span className="text-[#FF8FB1] font-normal italic inline-block mt-3 tracking-normal drop-shadow-xl">
                Artistry.
              </span>
            </h1>

            <p className="text-white/90 text-xl font-medium leading-relaxed drop-shadow-md max-w-2xl mx-auto mb-12">
              We are a magical cosmetics realm built for glow-seekers. Discover ethereal, fairy-dusted formulas designed to enchant and mesmerize.
            </p>

            <div className="flex flex-col sm:flex-row gap-5 justify-center">
              <Link to="/shop" className="flex items-center justify-center gap-2 px-10 py-4 bg-white/20 backdrop-blur-md text-white border border-white/50 rounded-full font-bold uppercase tracking-widest text-sm hover:bg-white hover:text-[#FF0069] hover:scale-105 transition-all shadow-[0_10px_30px_rgba(255,255,255,0.2)]">
                Explore The Magic
              </Link>
              <a href="#our-story" className="flex items-center justify-center gap-2 px-10 py-4 bg-[#FF0069]/80 backdrop-blur-md text-white rounded-full font-bold uppercase tracking-widest text-sm hover:bg-white hover:text-[#FF0069] hover:scale-105 transition-all shadow-lg">
                Our Tale
              </a>
            </div>
          </motion.div>
            ...
            <div className="w-full lg:w-[55%] lg:pr-12">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-5">
                  <Link to="/shop" className="flex items-center justify-center gap-2 px-10 py-4 bg-[#FF2D7A] text-white rounded-full font-bold uppercase tracking-widest text-sm hover:bg-[#E01B63] hover:shadow-[0_0_20px_rgba(255,45,122,0.4)] hover:scale-105 transition-all duration-300">
                    Explore Products
                  </Link>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="w-full lg:w-5/12 lg:sticky top-32">
              ...
              <div className="space-y-6 text-gray-600 font-medium text-lg leading-relaxed">
                <p>
                  {isCosmetics
                    ? "COSKINn was born from a desire to merge high-impact artistry with weightless, fairytale-dusted beauty. Indian cosmetics needed a fresh perspective—one that combined rich pigmentation, comfortable wear, and magical packaging."
                    : "COSKINn was born from a desire to merge high-performance skincare with effortless beauty. Indian beauty ecommerce needed a fresh perspective—one that combined trust, transparency, and the joyful power of fruit ingredients."}
                </p>
                <p>
                  {isCosmetics
                    ? "We created a curated, royalty-inspired soft-luxury makeup house designed for the modern glow-seeker. An enchanting shopping experience paired with formulas that blend like a dream."
                    : "We created a curated, concern-driven soft-luxury brand designed specifically for the modern Gen-Z and millennial lifestyle. A habit-forming shopping experience paired with formulas that simply work."}
                </p>
              </div>
              <div className="mt-12 p-8 bg-[#FFF5F8] rounded-[32px] border border-[#FF2D7A]/10 shadow-sm">
                ...
                <p className="text-gray-600 mb-8 font-medium">
                  {isCosmetics
                    ? "To empower every individual to express their inner magic through luxury, cruelty-free cosmetics that feel as incredible as they look."
                    : "To empower every individual to feel confident in their own skin through clean, science-backed fruit formulas."}
                </p>
                <h3 className="text-xl font-heading font-bold text-[#1B1B1B] mb-3">Our Vision</h3>
                <p className="text-gray-600 font-medium">
                  {isCosmetics
                    ? "To become India's most beloved luxury fairytale cosmetics brand, celebrated for intense pigmentation and weightless textures."
                    : "To become the go-to destination for fruit-based, concern-driven skincare and SPF-safe makeup across India."}
                </p>
              </div>
            </div>
            ...
            <div className="w-full lg:w-7/12 flex flex-col gap-8">
              {(isCosmetics ? [
                { year: "The Spark", title: "Enchanting Artistry", desc: "Noticing that luxury makeup was often heavy or drying, we sought a magical balance: intense color payoff with cloud-like comfort." },
                { year: "Formulation", title: "Fairytale Textures", desc: "Crafting velvety-matte lipsticks, gravity-defying mascaras, and buttery eyeshadow palettes that blend effortlessly." },
                { year: "The COSKINn Era", title: "Royalty & Magic", desc: "Bringing our fairy-dusted aesthetic and luxury cosmetics realm to beauty lovers everywhere." }
              ] : [
      ...
      <section className="py-24 bg-[#FAFAFA] relative overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {(isCosmetics ? [
              { icon: <Sparkles size={32} />, title: "Fairytale Artistry", desc: "Enchanted pigments and magical textures designed to elevate your everyday makeup ritual." },
              { icon: <FlaskConical size={32} />, title: "Weightless Comfort", desc: "High-impact color payoff crafted with skin-loving ingredients that never dry out or cake." },
              { icon: <Leaf size={32} />, title: "Clean & Cruelty-Free", desc: "100% vegan bristles and cruelty-free formulas. Gentle on your skin, kind to animals." },
              { icon: <Heart size={32} />, title: "Royal Vanity Aesthetic", desc: "Exquisite rose gold and angel-carved packaging that turns your vanity into a magical kingdom." }
            ] : [
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl lg:text-5xl font-heading font-bold text-[#1B1B1B] tracking-tight mb-6">
              {isCosmetics ? "Our Magical Formulation" : "Our Superfruit Lineup"}
            </h2>
            <p className="text-gray-600 text-lg font-medium">
              {isCosmetics
                ? "We blend fairytale aesthetics with skin-loving ingredients for a flawless finish."
                : "We extract the purest essence from nature's most powerful fruits."}
            </p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {(isCosmetics ? [
              { name: "Velvet Pigments", benefit: "Rich, bold, and intense color payoff for mesmerizing eyes and lips.", color: "bg-[#FFF0F4]", text: "text-[#FF2D7A]" },
              { name: "Luminous Shimmer", benefit: "Magical fairy-like glow that catches the light beautifully.", color: "bg-[#FFF9E6]", text: "text-[#D9A000]" },
              { name: "Rose Extract", benefit: "Soothing floral essence that hydrates and refreshes your makeup base.", color: "bg-[#FFF0F5]", text: "text-[#D60053]" },
              { name: "Shea Butter", benefit: "Creamy, ultra-hydrating base for our magnetic lipsticks and blushes.", color: "bg-[#FFF0E6]", text: "text-[#E67300]" },
              { name: "Hyaluronic Acid", benefit: "Locks in moisture so your makeup looks fresh and dewy all day.", color: "bg-[#F0F5FF]", text: "text-[#2D6AFF]" },
              { name: "Ceramides", benefit: "Protects your skin barrier even while wearing full glam.", color: "bg-[#F0FFF5]", text: "text-[#00A340]" },
            ] : [
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className={`${item.color} rounded-[32px] p-8 lg:p-10 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:scale-[1.02] transition-all duration-500`}
              >
                <div className={`text-2xl lg:text-3xl font-heading font-black ${item.text} mb-4`}>{item.name}</div>
                <p className="text-gray-700 font-medium text-sm lg:text-base leading-relaxed">{item.benefit}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
            ...
            <div className="md:col-span-2 bg-white rounded-[32px] p-10 flex flex-col justify-end relative overflow-hidden group shadow-sm border border-[#FF2D7A]/10 hover:border-[#FF2D7A]/30 transition-colors">
              ...
              <h3 className="text-3xl font-heading font-bold text-[#1B1B1B] mb-3 relative z-10">
                {isCosmetics ? "Fairytale Formulations" : "Fruit-Powered Ingredients"}
              </h3>
              <p className="text-gray-500 text-lg max-w-md relative z-10 font-medium">
                {isCosmetics
                  ? "Experience the magic of long-lasting, skin-loving makeup designed to make you feel like royalty."
                  : "We never use cheap fillers. Every drop is packed with real, nutrient-dense fruit extracts."}
              </p>
            </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {(isCosmetics ? [
              { name: "Ananya M.", product: "COSKINn Magnetic Lipstick", text: "The velvet-matte finish is stunning! It glides on like silk and stays comfortable through the entire day without drying." },
              { name: "Kavya R.", product: "COSKINn Lift & Curl Mascara", text: "Gives me the most dramatic princess lashes with zero clumping or flaking. Completely waterproof too!" },
              { name: "Sanaya D.", product: "COSKINn Velvet Blush", text: "The angel carving on the blush is so gorgeous I almost didn't want to use it. Gives the prettiest cloud-like flush!" }
            ] : [
      ...
      <section className="py-24 bg-[#FAFAFA]">
        <div className="w-[95%] lg:w-[90%] max-w-[1440px] mx-auto">
          ...
          <div className="space-y-4">
            {(isCosmetics ? [
              { q: "Are your cosmetics suitable for sensitive skin?", a: "Yes! All COSKINn cosmetics are dermatologically tested and formulated without harsh sulfates, parabens, or toxins, making them comfortable even for sensitive skin." },
              { q: "Do you test on animals?", a: "Never. We are proudly 100% cruelty-free and committed to ethical beauty." },
              { q: "Where are your products manufactured?", a: "All our products are proudly made in India, combining luxury cosmetic artistry with richly pigmented, skin-loving ingredients." },
      ...
      <section className="py-32 relative bg-white overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 text-center">
          ...
          <p className="text-xl text-gray-600 font-medium mb-12 max-w-2xl mx-auto leading-relaxed">
            {isCosmetics
              ? "Step into the enchanting world of COSKINn cosmetics and elevate your beauty ritual with richly pigmented, weightless fairytale formulas."
              : "Join the COSKINn revolution and transform your daily skincare routine into a luxurious, fruit-powered ritual."}
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <Link
              to={isCosmetics ? "/shop" : "/shop-all-skincare"}
              className="px-12 py-5 bg-[#FF2D7A] text-white rounded-full font-bold uppercase tracking-widest text-sm hover:bg-[#E01B63] hover:shadow-[0_15px_30px_rgba(255,45,122,0.3)] hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto"
            >
              {isCosmetics ? "Shop All Cosmetics" : "Shop Skincare"}
            </Link>
            <Link
              to={isCosmetics ? "/collections/magnetic-lipstick" : "/skin-quiz"}
              className="px-12 py-5 bg-white text-[#1B1B1B] border border-gray-200 rounded-full font-bold uppercase tracking-widest text-sm hover:border-[#FF2D7A]/50 hover:shadow-[0_15px_30px_rgba(0,0,0,0.05)] hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto"
            >
              {isCosmetics ? "Explore Collections" : "Take Skin Quiz"}
            </Link>
          </div>
        </div>
      </section>
