        ...
        >
          {routineProducts.map((product, idx) => (
            <div key={`${product.id}-${idx}`} className="w-[260px] md:w-[280px] shrink-0 snap-start flex flex-col group">
              ...
              <button
                onClick={() => addToCart(product, 1)}
                className="w-full py-3.5 border-2 border-pink-400 rounded-2xl text-pink-600 font-bold text-sm hover:bg-[#FF0069] hover:border-[#FF0069] hover:text-white transition-all flex items-center justify-center gap-2"
              >
