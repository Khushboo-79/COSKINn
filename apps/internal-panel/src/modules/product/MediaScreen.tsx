  ...
  return (
    <div className="h-full flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Select a product to upload and manage its images and videos.</p>
      </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-rose-100 p-6 overflow-y-auto">
          {selectedProductId ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-slate-400 space-y-4">
              ...
              <p className="text-sm font-medium">Select a product from the list to manage its media</p>
            </div>
          )}
        </div>
      </div>
