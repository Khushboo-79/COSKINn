...
import { Search, Filter, MessageSquare, Clock, CheckCircle, AlertCircle, Send, User, ChevronRight } from 'lucide-react';
              ...
              <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                ...
                <div className="flex items-center gap-2">
                  <span className={`px-2.5 py-1 text-xs font-bold rounded-lg uppercase tracking-wide flex items-center gap-1 ${
                    activeTicket.status === 'CLOSED' ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-700'
                  }`}>
                    {activeTicket.status}
                  </span>
