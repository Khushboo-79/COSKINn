...
const Hero: React.FC = () => {
  ...
  return (
    <section className={`relative overflow-hidden w-full flex flex-col transition-colors duration-700 ${
      ...
      <div className="relative z-10 w-full h-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between pt-16 md:pt-0 py-10 lg:py-16">
