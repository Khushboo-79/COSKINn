...
const ingredientsData = [
  ...
  { id: '4', title: 'Green Tea', image: require('../../../../images/bgImages/GreenTea.webp') },
  { id: '5', title: 'Pomegranate', image: require('../../../../images/bgImages/Pomegranate.webp') },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* Horizontal Scrollable Ingredients */}
            ...
            renderItem={({ item }) => {
              ...
              return (
                <TouchableOpacity 
                  ...
                  onPress={() => setActiveIngredient(item.id)}
                  activeOpacity={0.8}
                >
                  <View style={[styles.ingredientCircle]}>
                    <Image source={item.image} style={styles.ingredientImage} resizeMode="cover" />
                  </View>
...
const styles = StyleSheet.create({
  ...
  ingredientCircle: {
    ...
    borderWidth: 2,
    borderColor: '#FF0069', // Pink border around all ingredient circles
    overflow: 'hidden',
  },
  ingredientImage: {
    width: '100%',
...
export default ViewAllIngredientsScreen;
