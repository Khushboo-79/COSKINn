        ...
        <View style={styles.stepsRow}>
          <View style={styles.stepItem}>
            <View style={[styles.iconCircle, styles.iconCircleActive]}>
              <Icon name="gift" size={scaleh(16)} color={AppTheme.colors.primary} />
    ...
    <View style={styles.filledContainer}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.bagItemsHeaderRow}>
          ...
          <TouchableOpacity>
            <Icon name="trash-2" size={scaleh(20)} color={AppTheme.colors.primary} />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.accordionCardBox}>
          ...
          <View style={styles.boxRight}>
            ...
            <Switch
              trackColor={{ false: "#d3d3d3", true: AppTheme.colors.primary }}
        ...
        <View style={styles.priceDetailsContainer}>
          ...
          >
            <Text style={styles.rewardBannerText}>You will earn 1000 reward points with COS - LUXE</Text>
          </LinearGradient>
        </View>
                ...
                <View style={styles.lmDetails}>
                  ...
                  <View style={styles.lmActionRow}>
                    <TouchableOpacity style={styles.lmHeartBtn}>
                      <Icon name="heart" size={scaleh(14)} color={AppTheme.colors.primary} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.lmSelectBtn}>
                      <Text style={styles.lmSelectText}>Select Size</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
      ...
      {/* Sticky Bottom Bar */}
        <View style={styles.stickyBottomBar}>
          <LinearGradient
            colors={[AppTheme.colors.cartBottomGradientStart, AppTheme.colors.cartBottomGradientEnd]}
            style={styles.savingStrip}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 0 }}
          >
            <Text style={styles.savingText}>
              You are saving <Text style={styles.savingAmount}>₹99</Text>
            </Text>
          </LinearGradient>
