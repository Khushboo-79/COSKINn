    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          >
            <View style={[styles.radioCircle, selectedOption === 'blank' ? styles.radioSelectedBlank : styles.radioUnselected]} />
          ...
          >
            <View style={[styles.radioCircle, selectedOption === 'personal' ? styles.radioSelectedPersonal : styles.radioUnselected]} />
