...
const ViewAllNewArrivalsScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* Advertisements & Offers Banner */}
        <LinearGradient 
          colors={['#FFD1DC', '#FFF5F5', '#FFFFFF']} 
          style={styles.adBanner}
        >
          <Text style={styles.adBannerText}>Advertisments & Offers</Text>
        </LinearGradient>
...
export default ViewAllNewArrivalsScreen;
