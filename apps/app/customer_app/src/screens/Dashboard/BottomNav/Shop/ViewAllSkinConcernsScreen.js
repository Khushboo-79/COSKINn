...
const skinConcernsData = [
  { id: '1', title: 'Dullness', circleText: 'Uneven\nSkin Tone', color: '#DCD0FF', textColor: '#FFFFFF' },
  { id: '2', title: 'Dark Spots', circleText: 'Dark\nSpots', color: '#FFE4B5', textColor: '#CD853F' },
  { id: '3', title: 'Damaged Skin', circleText: 'Sensitive\nSkin', color: '#E0FFFF', textColor: '#008B8B' },
  { id: '4', title: 'Clogged Pores', circleText: 'Clogged\nPores', color: '#E6F2FF', textColor: '#4682B4' },
  { id: '5', title: 'Fine Lines', circleText: 'Loss of\nElasticity', color: '#FFF0F5', textColor: '#DB7093' },
  { id: '6', title: 'Dryness', circleText: 'Tired &\nDull Skin', color: '#E6E6FA', textColor: '#483D8B' },
];
...
const ViewAllSkinConcernsScreen = () => {
  const navigation = useNavigation();
  const [activeConcern, setActiveConcern] = useState('1'); // Select first concern initially
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* Horizontal Scrollable Skin Concerns */}
        <View style={styles.skinTypesWrapper}>
          <FlatList 
            ...
            renderItem={({ item }) => {
              ...
              return (
                <TouchableOpacity 
                  style={[styles.skinTypeItem]}
                  onPress={() => setActiveConcern(item.id)}
                  activeOpacity={0.8}
                >
                  <View style={[styles.concernCircle, { backgroundColor: item.color }, isActive && styles.concernCircleActive]}>
                    <Text style={[styles.concernText, { color: item.textColor }]}>{item.circleText}</Text>
                  </View>
...
export default ViewAllSkinConcernsScreen;
