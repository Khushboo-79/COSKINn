...
let RefundController = class RefundController {
    ...
    processWalletRefund(dto) {
        return this.refundService.processRefund(dto, 'WALLET');
    }
    processOriginalSourceRefund(dto) {
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'FINANCE'),
    (0, common_1.Post)('process/wallet'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [refund_dto_1.ProcessRefundDto]),
    __metadata("design:returntype", void 0)
], RefundController.prototype, "processWalletRefund", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'FINANCE'),
    (0, common_1.Post)('process/original-source'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [refund_dto_1.ProcessRefundDto]),
    __metadata("design:returntype", void 0)
], RefundController.prototype, "processOriginalSourceRefund", null);
