...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, product_dto_1.CreateProductVideoDto]),
    __metadata("design:returntype", Promise)
], MediaController.prototype, "addVideo", null);
__decorate([
    (0, common_1.Patch)('reorder'),
    __param(0, (0, common_1.Param)('productId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, product_dto_1.UpdateMediaOrderDto]),
    __metadata("design:returntype", Promise)
], MediaController.prototype, "reorderMedia", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MediaController.prototype, "removeImage", null);
__decorate([
    (0, common_1.Delete)('video/:videoId'),
    __param(0, (0, common_1.Param)('productId')),
    __param(1, (0, common_1.Param)('videoId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], MediaController.prototype, "removeVideo", null);
exports.MediaController = MediaController = __decorate([
    (0, common_1.Controller)('product/:productId/media'),
