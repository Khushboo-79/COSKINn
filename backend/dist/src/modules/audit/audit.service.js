...
let AuditService = class AuditService {
        ...
        const logs = [
            {
                ...
                entity: 'Admin',
                entityId: '402',
                adminId: 'superadmin@fairenne.com',
            ...
            },
            {
                ...
                entity: 'Admin',
                entityId: 'global',
                adminId: 'rolemanager@fairenne.com',
                newData: JSON.stringify({
            ...
            },
            {
                ...
                entity: 'ProductPrice',
                entityId: 'SKU-8801',
                adminId: 'productmgr@fairenne.com',
                oldData: JSON.stringify({ price: '₹45.00' }),
                newData: JSON.stringify({
            ...
            },
            {
                ...
                entity: 'ProductPrice',
                entityId: 'SKU-7722',
                adminId: 'admin@fairenne.com',
                oldData: JSON.stringify({ price: '₹25.00' }),
                newData: JSON.stringify({
            ...
            },
            {
                ...
                entityId: 'SKU-9918',
                adminId: 'productmgr@fairenne.com',
                oldData: JSON.stringify({ price: '₹55.00 (10% off)' }),
                newData: JSON.stringify({
                    productName: 'Retinol Night Cream',
                    price: '₹55.00 (No discount)',
                    reason: 'Promo ended',
                }),
    ...
    async getRefundReport() {
        ...
        return returns.map((r) => ({
            ...
            method: r.refundType,
            status: r.status,
            completionDate: r.status === 'RECEIVED'
                ? r.updatedAt.toISOString().replace('T', ' ').substring(0, 19)
                : '-',
